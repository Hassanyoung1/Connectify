# backend_connectify/backend/console.py
#!/usr/bin/python3
""" console """
...
class ConnectifyCommand(cmd.Cmd):
    """ Connectify console """
    prompt = '(connectify) '
    ...
    def do_update(self, arg):
        ...
        args = shlex.split(arg)
        integers = ["number_tracks", "duration"]
        floats = ["rating"]
        if len(args) == 0:
            print("** class name missing **")
        elif args[0] in classes:
